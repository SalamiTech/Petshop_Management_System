        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <div class="">
                        <h3 style="background-color: #ffff;font-weight: bold;"><img src="../images/1627478.png" height="30px" width="30px">&nbsp;&nbsp; Admin Login</h3>
                        <hr>
                        </hr>
                    </div>
                    <form role="form" id="logform">
                        ...
                        <button type="button" id="admin-login" class="btn btn-primary btn-flat m-b-30 m-t-30"><span id="logtext">Sign in</span></button><br><br>
                        <div>
